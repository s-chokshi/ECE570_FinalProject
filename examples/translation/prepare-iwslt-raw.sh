...
keep_len=$(( (95 * orig_len) / 100 ))  # keep 95% of data
...
new_len=$(wc -l < $tmp/train.tags.$lang.clean.$src)
percent_left=$(( 100 * new_len / orig_len ))
percent_removed=$(( 100 - percent_left ))
echo "Percentage of sentences removed by length filter: ${percent_removed}%"
